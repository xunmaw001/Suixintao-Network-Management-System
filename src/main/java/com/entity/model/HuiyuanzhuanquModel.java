 ...
 */
public class HuiyuanzhuanquModel  implements Serializable {
	...
	public void setGoumaishuoming(String goumaishuoming) {
		this.goumaishuoming = goumaishuoming;
	}
	
	/**
	 * 获取：购买说明
	 */
	public String getGoumaishuoming() {
		return goumaishuoming;
	}
