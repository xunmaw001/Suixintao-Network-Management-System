    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="购买说明" prop="goumaishuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="购买说明"
                  v-model="ruleForm.goumaishuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.goumaishuoming" label="购买说明" prop="goumaishuoming">
                    <span>{{ruleForm.goumaishuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='goumaishuoming'){
            this.ruleForm.goumaishuoming = obj[o];
	    this.ro.goumaishuoming = true;
            continue;
          }
	...
	this.ruleForm.shangpinjieshao = this.ruleForm.shangpinjieshao.replace(reg,'../../../ssm69bz5/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huiyuanzhuanqu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyuanzhuanquCrossAddOrUpdateFlag = false;
                  this.parent.search();
